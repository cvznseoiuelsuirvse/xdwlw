...
XDWL_MUST_CHECK int xdwl_send_request(xdwl_proxy *proxy, char *object_name,
                                      size_t method_id, size_t arg_count, ...);
XDWL_MUST_CHECK int xdwl_recv_events(xdwl_proxy *proxy,
                                     xdwl_list *messages_list);
XDWL_MUST_CHECK int xdwl_add_listener(xdwl_proxy *proxy,
                                      const char *object_name, void *interface,
                                      void *user_data);
