...
__must_check int xdwl_display_add_listener(xdwl_proxy *proxy,
...
__must_check int xdwl_registry_add_listener(xdwl_proxy *proxy,
...
__must_check int xdwl_callback_add_listener(xdwl_proxy *proxy,
...
__must_check int xdwl_shm_add_listener(xdwl_proxy *proxy,
                                       struct xdwl_shm *interface,
                                       void *user_data);
...
__must_check int xdwl_buffer_add_listener(xdwl_proxy *proxy,
                                          struct xdwl_buffer *interface,
                                          void *user_data);
...
__must_check int xdwl_data_offer_add_listener(xdwl_proxy *proxy,
...
__must_check int xdwl_data_source_add_listener(
    xdwl_proxy *proxy, struct xdwl_data_source *interface, void *user_data);
...
__must_check int xdwl_data_device_add_listener(
    xdwl_proxy *proxy, struct xdwl_data_device *interface, void *user_data);
...
__must_check int xdwl_shell_surface_add_listener(
    xdwl_proxy *proxy, struct xdwl_shell_surface *interface, void *user_data);
...
__must_check int xdwl_surface_add_listener(xdwl_proxy *proxy,
...
__must_check int xdwl_seat_add_listener(xdwl_proxy *proxy,
                                        struct xdwl_seat *interface,
                                        void *user_data);
...
__must_check int xdwl_pointer_add_listener(xdwl_proxy *proxy,
...
__must_check int xdwl_keyboard_add_listener(xdwl_proxy *proxy,
...
__must_check int xdwl_touch_add_listener(xdwl_proxy *proxy,
                                         struct xdwl_touch *interface,
                                         void *user_data);
...
__must_check int xdwl_output_add_listener(xdwl_proxy *proxy,
                                          struct xdwl_output *interface,
                                          void *user_data);
