...
void xdwl_display_add_listener(xdwl_proxy *proxy,
                               struct xdwl_display *interface, void *user_data);
 ...
 * operation, the invalid_finish protocol error is d. */
 ...
 * wl_data_offer.source_actions mask, an error will be d.
 *
 ...
 * for drag-and-drop will  a protocol error. */
 ...
 * already has another role, it s a protocol error.
 *
...
void xdwl_surface_add_listener(xdwl_proxy *proxy,
                               struct xdwl_surface *interface, void *user_data);
 ...
 * 'invalid_offset' error being d. The x and y arguments are ignored
...
void xdwl_pointer_add_listener(xdwl_proxy *proxy,
                               struct xdwl_pointer *interface, void *user_data);

/* set the pointer surface
 *
 * Set the pointer surface, i.e., the surface that contains the
 * pointer image (cursor). This request gives the surface the role
 * of a cursor. If the surface already has another role, it s
 * a protocol error.
 *
 ...
 * bad_surface protocol error is d.
 *
 ...
 * bad_parent protocol error is d.
 *
